...
export function CTABanner() {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 sm:py-20 md:py-28 text-white overflow-hidden bg-[var(--navy)]">
      {/* Background Image */}
      ...
      <Container className="relative z-10 px-4">
        <AnimateOnScroll animation="pop-up" className="text-center max-w-3xl mx-auto">
          <h2 className="font-display font-bold text-2xl sm:text-4xl md:text-5xl tracking-tight">Ready to Move Your Cargo?</h2>
          <p className="mt-4 sm:mt-6 text-white/70 text-base md:text-xl leading-relaxed">
          ...
          <div className="mt-8 sm:mt-12 flex flex-wrap justify-center gap-3 sm:gap-4">
            <CTAButton href="/quote" variant="primary" size="lg" className="btn-hover-lift w-full sm:w-auto">
              Request a Quote
            </CTAButton>
            <CTAButton href={SITE_SETTINGS.social.whatsapp} variant="light" size="lg" external className="btn-hover-lift w-full sm:w-auto">
              WhatsApp
            </CTAButton>
          </div>
        </AnimateOnScroll>
